...
import { useTransactionForm } from "@/presentation/hooks/useTransactionForm";
import { useTransactionFile } from "@/presentation/hooks/useTransactionFile";
...
export function EditTransactionModal({ transaction, onClose }: Props) {
  ...
  const { refresh, updateTransaction } = useTransactions();
  ...
  async function handleSubmit() {
    try {
      ...
      if (response.transactions) {
        resetForm();
        resetFile();
        updateTransaction(response.transactions);
        onClose();
        refresh();
